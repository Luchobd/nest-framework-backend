...
export class ProductsService {
  private readonly logger = new Logger('ProductsService'); // !Ver mis propios "LOG" como los muestra Nest.
  ...
  async create(createProductDto: CreateProductDto, user: User) {
    try {
      ...
      //   // createProductDto.slug = createProductDto.title.replace(/\s/g, '-').toLowerCase();
